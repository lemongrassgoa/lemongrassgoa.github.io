	            ...
	            for(var rowCell = 0; rowCell < rowCells.length; rowCell++){
	                if(singleRow === 0){
                        ...
                        if(rowCell === 0){
                            ...
                            table += '<style>#_'+temp+'::before{content: "'+(singleRow-total)+'"; font-size: 80%;color: silver; float: left; position: relative; right: 0.5em; } @media (max-width: 400px) {#_'+temp+'::before{ display:none;}}</style>';
